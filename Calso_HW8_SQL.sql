...
# 4a
select last_name, count(*) as 'number of actors with last name' from actor group by last_name;

# 4b
select last_name, count(*) as 'number of actors with last name' from actor group by last_name having count(*) >= 2;
